...
var alph = prompt("Enter The Alphabet");
...
var a = prompt("Enter the Alphabet");
...
var week = prompt("Enter Week Number(1-7)");
if (week == 1) {
    console.log("Monday");
}
else if (week == 2) {
...
var a = prompt("Enter Month Number(1-12)");
if (a == 2) {
...
var d = prompt("Enter Angle a");
var e = prompt("Enter Angle b");
var f = prompt("Enter Angle c");
var a = parseInt(d);
var b = parseInt(e);
var c = parseInt(f);
var sum = a + b + c;
...
var a = prompt("Enter Buying Cost");
var b = prompt("Enter Selling Cost");
if (b > a) {
    console.log("Profit");
}
else {
...
var a = prompt("Enter Physics Marks");
var b = prompt("Enter Chemistery Marks");
var c = prompt("Enter Math Marks");
var d = prompt("Enter Urdu Marks");
...
var urdu = parseInt(d);
var eng = parseInt(e);
var marks = phy + chem + math + urdu + eng;
var a = (marks / total) * 100;
if (a >= 90) {
...
var da = (80 / 100) * basic;
var hraa = (25 / 100) * basic;
var daa = (90 / 100) * basic;
var hraaa = (30 / 100) * basic;
var daaa = (95 / 100) * basic;
if (basic <= 10000) {
...
var bill = parseInt(prompt("Enter Total Units:"));
if (bill <= 50) {
    var add = 0.50 * bill;
